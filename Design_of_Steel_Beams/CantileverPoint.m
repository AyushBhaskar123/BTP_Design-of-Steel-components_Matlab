function varargout = CantileverPoint(varargin)
% CANTILEVERPOINT MATLAB code for CantileverPoint.fig
%      CANTILEVERPOINT, by itself, creates a new CANTILEVERPOINT or raises the existing
%      singleton*.
%
%      H = CANTILEVERPOINT returns the handle to a new CANTILEVERPOINT or the handle to
%      the existing singleton*.
%
%      CANTILEVERPOINT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CANTILEVERPOINT.M with the given input arguments.
%
%      CANTILEVERPOINT('Property','Value',...) creates a new CANTILEVERPOINT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before CantileverPoint_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to CantileverPoint_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help CantileverPoint

% Last Modified by GUIDE v2.5 19-Aug-2019 21:35:29

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @CantileverPoint_OpeningFcn, ...
                   'gui_OutputFcn',  @CantileverPoint_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before CantileverPoint is made visible.
function CantileverPoint_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to CantileverPoint (see VARARGIN)

% Choose default command line output for CantileverPoint
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes CantileverPoint wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = CantileverPoint_OutputFcn(hObject, eventdata, handles) 
