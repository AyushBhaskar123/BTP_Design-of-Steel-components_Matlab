function varargout = SimplyPointUdl(varargin)
% SIMPLYPOINTUDL MATLAB code for SimplyPointUdl.fig
%      SIMPLYPOINTUDL, by itself, creates a new SIMPLYPOINTUDL or raises the existing
%      singleton*.
%
%      H = SIMPLYPOINTUDL returns the handle to a new SIMPLYPOINTUDL or the handle to
%      the existing singleton*.
%
%      SIMPLYPOINTUDL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SIMPLYPOINTUDL.M with the given input arguments.
%
%      SIMPLYPOINTUDL('Property','Value',...) creates a new SIMPLYPOINTUDL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SimplyPointUdl_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SimplyPointUdl_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SimplyPointUdl

% Last Modified by GUIDE v2.5 19-Aug-2019 22:50:44

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SimplyPointUdl_OpeningFcn, ...
                   'gui_OutputFcn',  @SimplyPointUdl_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SimplyPointUdl is made visible.
function SimplyPointUdl_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SimplyPointUdl (see VARARGIN)

% Choose default command line output for SimplyPointUdl
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes SimplyPointUdl wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SimplyPointUdl_OutputFcn(hObject, eventdata, handles) 
