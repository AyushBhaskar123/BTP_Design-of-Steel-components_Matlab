function varargout = LaterallySupportedResult(varargin)
% LATERALLYSUPPORTEDRESULT MATLAB code for LaterallySupportedResult.fig
%      LATERALLYSUPPORTEDRESULT, by itself, creates a new LATERALLYSUPPORTEDRESULT or raises the existing
%      singleton*.
%
%      H = LATERALLYSUPPORTEDRESULT returns the handle to a new LATERALLYSUPPORTEDRESULT or the handle to
%      the existing singleton*.
%
%      LATERALLYSUPPORTEDRESULT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in LATERALLYSUPPORTEDRESULT.M with the given input arguments.
%
%      LATERALLYSUPPORTEDRESULT('Property','Value',...) creates a new LATERALLYSUPPORTEDRESULT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before LaterallySupportedResult_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to LaterallySupportedResult_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help LaterallySupportedResult

% Last Modified by GUIDE v2.5 11-Sep-2019 17:21:14

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @LaterallySupportedResult_OpeningFcn, ...
                   'gui_OutputFcn',  @LaterallySupportedResult_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before LaterallySupportedResult is made visible.
function LaterallySupportedResult_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to LaterallySupportedResult (see VARARGIN)

% Choose default command line output for LaterallySupportedResult
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes LaterallySupportedResult wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = LaterallySupportedResult_OutputFcn(hObject, eventdata, handles) 
...
set(handles.edit24,'String',w);
set(handles.edit2,'String',H);
set(handles.edit3,'String',Bf);
set(handles.edit4,'String',Tf);
set(handles.edit5,'String',Rf);
set(handles.edit6,'String',Tw);
set(handles.edit7,'String',d);
...
set(handles.edit19,'String',Fwb);
set(handles.edit20,'String',Fwc);
set(handles.edit25,'String',Zd);
set(handles.edit26,'String',Za);

if (V<=X3)
    set(handles.edit17,'String','V < (0.6*Vd)');
    set(handles.edit18,'String','Low Shear');
else 
    set(handles.edit17,'String','V > (0.6*Vd)');
    set(handles.edit18,'String','High Shear');
end


if (X1<=9.4) && (X2<=84)
    set(handles.edit8,'String','Plastic');
elseif (X1<=10.5) && (X2<=105)
    set(handles.edit8,'String','Compact');
elseif (X1<=15.7) && (X2<=126)
    set(handles.edit8,'String','Semi-Compact');
end
